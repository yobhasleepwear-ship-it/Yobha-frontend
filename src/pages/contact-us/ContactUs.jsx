...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-premium-cream pt-24 md:pt-32">
      {/* Hero Section */}
      <section className="relative py-8 md:py-12 bg-gradient-to-br from-premium-beige via-premium-cream to-premium-warm-white overflow-hidden">
